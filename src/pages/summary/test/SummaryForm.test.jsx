...
import {
//   mockedContextWith_ToppingsAndScoops,
  mockedContextWith_OnlyScoops,
//   mockedContextWith_Nothing,
  customRender,
} from "./customRenderWithProvider";
...
test.only("no toppings added so no toppings will be shown", () => {
  customRender(<SummaryForm></SummaryForm>,{providerValue:mockedContextWith_OnlyScoops});
  const toppings = screen.queryByText(/Toppings/i,{exact:false});
